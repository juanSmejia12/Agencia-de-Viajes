<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Registrar Paquete Turístico') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('paquete.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcion" id="descripcion" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" rows="3" required></textarea>
                    </div>

                    <div class="mb-4">
                        <label for="duracion" class="block text-sm font-medium text-gray-700">Duración (días)</label>
                        <input type="number" name="duracion" id="duracion" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="incluye" id="incluye" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" rows="2" required></textarea>
                    </div>
